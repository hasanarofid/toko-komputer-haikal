  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" {{ route('admin.index') }} " target="_blank">
        <img src="{{ asset('logoteknisi.jpeg') }}" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold">{{ !empty($profile->title) ?  $profile->title :  'MarketPlace' }}</span>
      </a>
    </div>
    ...
    <div class="sidenav-footer mx-3 ">
      <div class="card card-plain shadow-none" id="sidenavCard">
        <img class="w-50 mx-auto" src="{{ asset('paneladmin/assets/img/illustrations/icon-documentation.svg') }} " alt="sidebar_illustration">
